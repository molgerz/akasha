...
/**
 * `buildTree` lifts the children of a hidden page to the top level, so the
 ...
 */
describe('PageView breadcrumbs and a hidden parent', () => {
  ...
  it('stops at a hidden parent, as the tree does', async () => {
    vi.mocked(useSpace).mockReturnValue(
      snapshot([
